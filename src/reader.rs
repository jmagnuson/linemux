            ...
            notify::EventKind::Create(create_event) => {
                match state.await_state {
                    HandleEventAwaitState::Idle => {
                        ...
                        match (cfg!(any(target_os = "windows", target_os = "freebsd", target_os = "macos")), create_event) {
            ...
            notify::EventKind::Modify(modify_event) => {
                match state.await_state {
                    HandleEventAwaitState::Idle => {
                        ...
                        match (cfg!(any(target_os = "windows", target_os = "freebsd", target_os = "macos")), modify_event) {
