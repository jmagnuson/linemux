...
impl MuxedEvents {
    ...
    fn add_directory(&mut self, path: impl AsRef<Path> + Into<PathBuf>) -> io::Result<()> {
    ...
    pub fn add_file(&mut self, path: impl AsRef<Path> + Into<PathBuf>) -> io::Result<PathBuf> {
